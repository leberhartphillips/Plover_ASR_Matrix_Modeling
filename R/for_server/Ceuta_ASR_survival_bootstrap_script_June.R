...
write.table(Ceuta_AIC_table_C, 
            file = "/home/luke/comparative_ASR/Bootstrap/Total_output/June2/Ceuta_AIC_table_C_June2.txt",
            sep = "\t", row.names = FALSE, 
            col.names = TRUE, append = FALSE)

write.table(Ceuta_AIC_table_F_A, 
            file = "/home/luke/comparative_ASR/Bootstrap/Total_output/June2/Ceuta_AIC_table_F_A_June2.txt",
            sep = "\t", row.names = FALSE, 
            col.names = TRUE, append = FALSE)

write.table(Ceuta_Survival_rates, 
            file = "/home/luke/comparative_ASR/Bootstrap/Total_output/June2/Ceuta_Survival_rates_June2.txt",
            sep = "\t", row.names = FALSE, 
            col.names = TRUE, append = FALSE)

write.table(Ceuta_Capture_rates, 
            file = "/home/luke/comparative_ASR/Bootstrap/Total_output/June2/Ceuta_Capture_rates_June2.txt",
            sep = "\t", row.names = FALSE, 
            col.names = TRUE, append = FALSE)

write.table(Ceuta_ASR, 
            file = "/home/luke/comparative_ASR/Bootstrap/Total_output/June2/Ceuta_ASR_June2.txt",
            sep = "\t", row.names = FALSE, 
            col.names = TRUE, append = FALSE)

write.table(Ceuta_FYSR, 
            file = "/home/luke/comparative_ASR/Bootstrap/Total_output/June2/Ceuta_FYSR_June2.txt",
            sep = "\t", row.names = FALSE, 
            col.names = TRUE, append = FALSE)