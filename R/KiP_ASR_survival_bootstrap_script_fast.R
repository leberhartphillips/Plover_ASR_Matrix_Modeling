...
calc_ASR_KiP <- function(plover_boot_list, num_boot) {
  ...
  {
    setwd("/home/luke/comparative_ASR/Bootstrap/RMark_output_files/KiP/Juv_adult/Fast_run/") 
  ...
  {
    setwd("/home/luke/comparative_ASR/Bootstrap/RMark_output_files/KiP/Chick/Fast_run/") 
...
write.table(KiP_AIC_table_C, 
            file = "/home/luke/comparative_ASR/Bootstrap/Total_output/KiP_AIC_table_C_fast.txt",
            sep = "\t", row.names = FALSE, 
            col.names = TRUE)

write.table(KiP_AIC_table_F_A, 
            file = "/home/luke/comparative_ASR/Bootstrap/Total_output/KiP_AIC_table_F_A_fast.txt",
            sep = "\t", row.names = FALSE, 
            col.names = TRUE)

write.table(KiP_Survival_rates, 
            file = "/home/luke/comparative_ASR/Bootstrap/Total_output/KiP_Survival_rates_fast.txt",
            sep = "\t", row.names = FALSE, 
            col.names = TRUE)

write.table(KiP_ASR, 
            file = "/home/luke/comparative_ASR/Bootstrap/Total_output/KiP_ASR_fast.txt",
            sep = "\t", row.names = FALSE, 
            col.names = TRUE)